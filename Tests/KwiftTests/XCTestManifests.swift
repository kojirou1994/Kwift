...
extension NSLockAtomicTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__NSLockAtomicTests = [
        ("testNSLockAtomic", testNSLockAtomic),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(NSLockAtomicTests.__allTests__NSLockAtomicTests),
